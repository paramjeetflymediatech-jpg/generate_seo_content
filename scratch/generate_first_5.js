...
// Target cities: First 5 from cities.json
const targetCities = ["Surrey", "Calgary", "Edmonton", "Red Deer", "Lethbridge"];
...
async function start() {
    ...
    console.log(`Found ${tasks.length} services needing update in target cities.`);
